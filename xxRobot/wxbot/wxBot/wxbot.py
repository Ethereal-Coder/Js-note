...
class WXBot:
    ...
    def get_contact(self):
        ...
        print self.get_user_id(self.my_account['UserName'])
    ...
    def run(self):
        try:
            ...
            if self.login():
                ...
                #登录成功
                ZkCli.updateState(ZkCli.wx_states["logined"])
            else:
    ...
    def gen_qr_code(self, qr_file_path):
        ...
        if self.conf['qr'] == 'png':
            ...
            Mail.send(qr_file_path)
            Mail.printBase64(qr_file_path)
    ...
    def login(self):
        ...
        # url= url.replace("wx2.","wx.")
        r = self.session.get(url+"&version=v2")
        r.encoding = 'utf-8'
        data = r.text
